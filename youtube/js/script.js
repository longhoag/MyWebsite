...
function transition() {
    if (isCorrect) {
        ...
        if (score == 0) {
            document.getElementById('game-over-wrapper').style.background = "linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('youtube/gifs/score_0.gif')";
            document.getElementById('ending-text').innerHTML = "I don't think I have to say much here..."
        }else if (score == 1) {
            document.getElementById('game-over-wrapper').style.background = "linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('youtube/gifs/score_1.gif')";
            ...
            document.getElementById('game-over-wrapper').style.background = "linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('youtube/gifs/score_2.gif')";
            document.getElementById('ending-text').innerHTML = "Overall, a pretty mediocre performance."
        }else if (score == 3) {
            document.getElementById('game-over-wrapper').style.background = "linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('youtube/gifs/score_3.gif')";
            document.getElementById('ending-text').innerHTML = "Average... painfully average."
        }else if (score == 4) {
            document.getElementById('game-over-wrapper').style.background = "linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('youtube/gifs/score_4.gif')";
            document.getElementById('ending-text').innerHTML = "Not bad. Not good either, but not bad."
        }else if (score == 5) {
            document.getElementById('game-over-wrapper').style.background = "linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('youtube/gifs/score_5.gif')";
            document.getElementById('ending-text').innerHTML = "Pretty good honestly. 10 is better though... 2 times better."
        }else if (score == 6) {
            document.getElementById('game-over-wrapper').style.background = "linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('youtube/gifs/score_6.gif')";
            document.getElementById('ending-text').innerHTML = "That's a pretty respectable score. Get to 10 to prove you are a real master!"
        }else if (score == 7) {
            document.getElementById('game-over-wrapper').style.background = "linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('youtube/gifs/score_7.gif')";
            document.getElementById('ending-text').innerHTML = "A respectable score indeed, but only true legends make it to 10"
        }else if (score == 8) {
            document.getElementById('game-over-wrapper').style.background = "linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('youtube/gifs/score_8.gif')";
            document.getElementById('ending-text').innerHTML = "I'm impressed. Get to 10 to become a legend."
        }else if (score == 9) {
            document.getElementById('game-over-wrapper').style.background = "linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('youtube/gifs/score_9.jpg')";
            document.getElementById('ending-text').innerHTML = "You were so close..."
        }else if (score >= 10) {
            document.getElementById('game-over-wrapper').style.background = "linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('youtube/gifs/score_10.jpg')";
